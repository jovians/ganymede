...
mkdir -p "profiles/$PRODUCT_NAME/src/assets/contents"
...
mkdir -p "profiles/$PRODUCT_NAME/src/app/main"
...
cp -R src/assets/contents/* "profiles/$PRODUCT_NAME/src/assets/contents"
