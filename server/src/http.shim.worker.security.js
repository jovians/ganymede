...
var SecureChannelWorkerClient = /** @class */ (function (_super) {
    ...
    SecureChannelWorkerClient.workerFile = __filename;
...
var thisWorkerClass = SecureChannelWorkerClient;
var SecureChannelWorkerLogic = /** @class */ (function (_super) {
    ...
    SecureChannelWorkerLogic.prototype.handleAction = function (callId, action, payload) {
        return __awaiter(this, void 0, void 0, function () {
            var sig, peerInfo, channel;
            return __generator(this, function (_a) {
                switch (action) {
                    case 'signMessage':
                        sig = fourq_1.FourQ.sign(Buffer.from(payload, 'base64'), this.signingKey);
                        return [2 /*return*/, this.returnCall(callId, sig.data.toString('base64'))];
                    case 'newChannel':
                        peerInfo = JSON.parse(payload);
                        peerInfo.ecdhPublicKey = Buffer.from(peerInfo.ecdhPublicKey, 'base64');
                        channel = new secure_channel_1.SecureChannel(peerInfo.type, 'generate', JSON.parse(payload));
                        return [2 /*return*/, this.returnCall(callId, channel.toJSON())];
                }
                return [2 /*return*/];
            });
        });
